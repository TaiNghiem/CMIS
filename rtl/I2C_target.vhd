...
architecture rtl of I2C_target is
    ...
    --signal SDA_rising_edge  : std_logic := '0';
    --signal SDA_falling_edge  : std_logic := '0';
    ...
    begin
        if rising_edge(clk) then
            ...
            case state is
                ...
                --during transaction, state only change when scl is low
                when get_first_byte =>
